...
function sendEmail($to,$title,$content){
	...
	$pm->Username = 'manbawei'; // （邮箱@前面的一部分）登录SMTP服务器的用户名
	$pm->Password = 'manba123'; //授权码 登录SMTP服务器的密码

	// 发件人信息
	$pm->From = 'manbawei@163.com';   //注册时候的邮箱
	$pm->FromName = '曼巴尾';  //当前邮箱用户的别名
...
//Demo调用 
//给手机号18948727421发送验证码为1234，两分钟内有效，1号模板
//【云通讯】您使用的是云通讯短信模板，您的验证码是1234，请于2分钟内正确输入
// sendSms(18948727421,array('1234',2),'1')
